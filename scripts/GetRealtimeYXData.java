...
public class GetRealtimeYXData
{
     private static final Logger logger = Logger.getLogger(GetRealtimeYXData.class);
     static {
   ...
   public static void main(String args[]) throws Exception {
     ...
     String keyInput  = "{\"pIDs\":[1,2,3,4],\"n\":4,\"name\":[\"station1_YC_1\",\"station1_YC_2\",\"station1_YC_3\",\"station1_YC_4\"]}";
     ...
     JSONObject keyInputObj = JSON.parseObject(keyInput);//字符砖转为json结构体  
